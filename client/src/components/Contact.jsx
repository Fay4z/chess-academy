...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:8000/formData', formVal);
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="mb-9 leading-relaxed text-lg">
                  Whether you're seeking for Chess program details or guidance, our team is just a call away for any assistance you need
                </p>
